...
public class Entertainment<imageButton> extends Activity {
		...
		((View) poli).setOnClickListener(new OnClickListener()
				
				{
					...
					public void onClick(View v) {
						...
						Intent in=new Intent(Entertainment.this,Home.class);
						startActivity(in);
   ...
   @Override
   public void onClick(View v) {
    Intent sIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:09324661664"));
   ...
   @Override
   public void onClick(View v) {
    Intent sIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:02462241110"));
    startActivity(sIntent);
   }
  });
   ...
   @Override
   public void onClick(View v) {
    Intent sIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:02462234114"));
    startActivity(sIntent);
   }
  });
   ...
   @Override
   public void onClick(View v) {
    Intent sIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:9011027190"));
    startActivity(sIntent);
   }
  });
   ...
   @Override
   public void onClick(View v) {
    Intent sIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:02462250949"));
    startActivity(sIntent);
   }
  });
