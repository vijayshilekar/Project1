...
String income=request.getParameter("ocupaa");
String occup=request.getParameter("dhanda");
...
PreparedStatement stmt=con.prepareStatement("insert into appfill values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
stmt.setString(14,income);
stmt.setString(15,occup);
stmt.executeUpdate();
con.close();
...
session.setAttribute("occup",occup);
%>
